  ...
  _proto.view = function view() {
    ...
    if (!this.loaded) {
      return m("div", {
        ...
        loading: true
      }, app.translator.trans('gtdxyz-flarum-badges.admin.auto_moderator.badge_selector.loading_badges')));
    }

    var badge = app.store.getById('badges', this.attrs.value);
    var label = badge ? [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_4___default()(badge.icon()), '\t', badge.name()] : app.translator.trans('gtdxyz-flarum-badges.admin.auto_moderator.badge_selector.placeholder');
    return m("div", {
      className: "Form-group"
...
var ConfirmModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return app.translator.trans("gtdxyz-flarum-badges.admin.confirm_dialog.title");
  };
  ...
  _proto.content = function content() {
    ...
    }, app.translator.trans('gtdxyz-flarum-badges.admin.confirm_dialog.no')), flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default().component({
      className: 'Button Button--primary',
      loading: this.loading,
      onclick: function onclick() {
        return _this.confirm();
      }
    }, app.translator.trans('gtdxyz-flarum-badges.admin.confirm_dialog.yes')))];
  }
  /**
   * Confirm
   */
...
var EditBadgeCategoryModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return app.translator.trans("gtdxyz-flarum-badges.admin." + (this.badgeCategory.exists ? 'update_category' : 'create_category'));
  };
  ...
  _proto.data = function data() {
    ...
    items.add('name', m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.name'), ":"), m("input", {
    ...
    items.add('description', m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.description'), ":"), m("textarea", {
      className: "FormControl",
      placeholder: app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.description'),
    ...
    }, [m("b", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.blockview')), m("div", {
      className: "helpText"
    }, app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.blockview_description'))])), 50); // Enabled
    ...
    }, [m("b", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.enabled')), m("div", {
      className: "helpText"
    }, app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.enabled_description'))])), 50);
    return items;
  };
...
var EditBadgeModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.className = function className() {
    return this.isImage() ? 'Modal--small in' : 'Modal--large in';
  };

  _proto.title = function title() {
    return app.translator.trans("gtdxyz-flarum-badges.admin." + (this.badge.exists ? 'update_badge' : 'new_badge'));
  };
  ...
  _proto.data = function data() {
    ...
    items.add('name', m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.name'), ":"), m("input", {
      className: "FormControl",
      placeholder: app.translator.trans('gtdxyz-flarum-badges.admin.badge.name'),
      bidi: this.name
    })), 50);
    items.add('description', m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.description'), ":"), m("textarea", {
      className: "FormControl",
      placeholder: app.translator.trans('gtdxyz-flarum-badges.admin.badge.description'),
      bidi: this.description
    })), 50); // Is image
    ...
    }, [m("b", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.is_image')), m("div", {
      className: "helpText"
    }, app.translator.trans('gtdxyz-flarum-badges.admin.badge.is_image_description'))])), 50); // Image field

    if (this.isImage()) {
      items.add('image', m("div", {
        className: "Form-group"
      }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.image'), ":"), m("input", {
        className: "FormControl",
      ...
      }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.icon'), ":"), m("input", {
        className: "FormControl",
      ...
      }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.icon_color'), ":"), m("input", {
        className: "FormControl",
        placeholder: "auto",
        bidi: this.iconColor
      }), m("span", {
      ...
      items.add('label_color', m("div", {
        className: "Form-group BadgeForm-split BadgeForm-ColorField"
      }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.label_color'), ":"), m("input", {
        className: "FormControl",
        placeholder: "auto",
    ...
    items.add('background_color', m("div", {
      className: !this.isImage() ? "Form-group BadgeForm-ColorField BadgeForm-split" : "Form-group BadgeForm-ColorField"
    }, m("label", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.background_color'), ":"), m("input", {
      className: "FormControl",
    ...
    }, [m("b", null, app.translator.trans('gtdxyz-flarum-badges.admin.badge.visible')), m("div", {
      className: "helpText"
    }, app.translator.trans('gtdxyz-flarum-badges.admin.badge.visible_description'))])), 50);
    return items;
  };
...
var InstallAutoModerationMessage = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
    ...
    }, app.translator.trans('gtdxyz-flarum-badges.admin.auto_moderator.not_installed.title')), m("div", {
      className: 'FlarumBadges-install-dependency-content'
    }, app.translator.trans('gtdxyz-flarum-badges.admin.auto_moderator.not_installed.content', {
      a: m("a", {
      ...
      "class": "Button-label"
    }, app.translator.trans(extensionInstalled ? 'core.admin.extension.open_modal' : 'gtdxyz-flarum-badges.admin.auto_moderator.not_installed.install'))), m((flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: 'Button',
      onclick: function onclick() {
      ...
      icon: 'fas fa-times'
    }, app.translator.trans('gtdxyz-flarum-badges.admin.auto_moderator.not_installed.dismiss'))));
  };
...
var SettingsPage = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    ...
    return m("div", {
      className: "ExtensionPage-settings FlarumBadgesPage"
    }, m("div", {
      className: "container"
    }, m("div", {
    ...
    }, app.translator.trans('gtdxyz-flarum-badges.admin.create_category')), m((flarum_components_Button__WEBPACK_IMPORTED_MODULE_5___default()), {
      className: 'Button',
      onclick: function onclick() {
        return app.modal.show(_EditBadgeModal__WEBPACK_IMPORTED_MODULE_6__["default"]);
      },
      icon: 'fas fa-icons'
    }, app.translator.trans('gtdxyz-flarum-badges.admin.new_badge'))), m("div", null, !this.loading && m("div", {
      ...
      return m("div", {
      ...
      }, app.translator.trans('gtdxyz-flarum-badges.admin.edit_category')), m("a", {
        href: 'javascript:void(0)',
        onclick: function onclick() {
        ...
        onclick: function onclick() {
          return app.modal.show(_ConfirmModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
            text: app.translator.trans('gtdxyz-flarum-badges.admin.confirm_messages.delete_category'),
            promise: true,
      ...
      className: 'CategoryName'
    }, m("b", null, app.translator.trans('gtdxyz-flarum-badges.admin.uncategorized')))), m("ul", {
      className: 'SortableBadges'
      ...
      size: 'big'
    }), !this.loading && uncategorizedBadges.length === 0 && categories.length === 0 && m("p", null, app.translator.trans('gtdxyz-flarum-badges.admin.nothing_here_yet')), this.buildSettingComponent({
      type: 'switch',
      setting: 'gtdxyz-badges.show_badges_on_user_card',
      label: app.translator.trans('gtdxyz-flarum-badges.admin.show_badges_on_user_card')
    }), this.buildSettingComponent({
      type: 'number',
      setting: 'gtdxyz-badges.number_of_badges_on_user_card',
      label: app.translator.trans('gtdxyz-flarum-badges.admin.number_of_badges_on_user_card'),
      help: app.translator.trans('gtdxyz-flarum-badges.admin.number_of_badges_on_user_card_help')
    }), m("div", {
      className: "Form-group"
    }, this.submitButton())));
  };
    ...
    return m("li", {
      ...
      onclick: function onclick() {
        return app.modal.show(_ConfirmModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
          text: app.translator.trans('gtdxyz-flarum-badges.admin.confirm_messages.delete_badge'),
          promise: true,
          onconfirm: function onconfirm(resolve, reject) {
...
app.initializers.add('gtdxyz-badges', function () {
  ...
  app.extensionData["for"]('gtdxyz-badges').registerPage(_components_SettingsPage__WEBPACK_IMPORTED_MODULE_3__["default"]);
  app.extensionData["for"]('gtdxyz-badges').registerPermission({
    icon: 'fas fa-users',
    label: app.translator.trans('gtdxyz-flarum-badges.admin.permissions.badge_detail_users'),
    permission: 'badges.canViewDetailedUsers',
    allowGuest: true
  }, 'view', 90).registerPermission({
    icon: 'fas fa-id-card',
    label: app.translator.trans('gtdxyz-flarum-badges.admin.permissions.edit_own_card_badges'),
    permission: 'badges.editOwnUserCardBadges'
  }, 'start', 90).registerPermission({
    icon: 'fas fa-address-card',
    label: app.translator.trans('gtdxyz-flarum-badges.admin.permissions.edit_card_badges'),
    permission: 'badges.editUserCardBadges'
  }, 'moderate', 90).registerPermission({
    icon: 'fas fa-user-tag',
    label: app.translator.trans('gtdxyz-flarum-badges.admin.permissions.give_badge'),
    permission: 'badges.giveBadge'
  }, 'moderate', 90).registerPermission({
    icon: 'fas fa-user-times',
    label: app.translator.trans('gtdxyz-flarum-badges.admin.permissions.take_badge'),
