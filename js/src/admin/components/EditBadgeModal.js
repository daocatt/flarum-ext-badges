  ...
  data() {
    ...
    items.add(
      ...
      <div className="Form-group">
        <label>{app.translator.trans('gtdxyz-flarum-badges.admin.badge.name')}:</label>
        <input className="FormControl" placeholder={app.translator.trans('gtdxyz-flarum-badges.admin.badge.name')} bidi={this.name} />
      </div>,
      50
    );
    ...
    items.add(
      'description',
      <div className="Form-group">
        <label>{app.translator.trans('gtdxyz-flarum-badges.admin.badge.description')}:</label>
        <textarea
    ...
    items.add(
      ...
      <div className="Form-group">
        {Switch.component(
          ...
          [
            <b>{app.translator.trans('gtdxyz-flarum-badges.admin.badge.is_image')}</b>,
            <div className="helpText">{app.translator.trans('gtdxyz-flarum-badges.admin.badge.is_image_description')}</div>,
          ]
        )}
      </div>,
      50
    ...
    // Non-image fields
      ...
      items.add(
        ...
        <div className="Form-group BadgeForm-split BadgeForm-IconField">
          <label>{app.translator.trans('gtdxyz-flarum-badges.admin.badge.icon')}:</label>
      ...
      items.add(
        ...
        <div className="Form-group BadgeForm-split BadgeForm-ColorField">
          <label>{app.translator.trans('gtdxyz-flarum-badges.admin.badge.icon_color')}:</label>
      ...
      items.add(
        'label_color',
        <div className="Form-group BadgeForm-split BadgeForm-ColorField">
          <label>{app.translator.trans('gtdxyz-flarum-badges.admin.badge.label_color')}:</label>
    ...
    items.add(
      ...
      <div className="Form-group">
        {Switch.component(
          ...
          [
            <b>{app.translator.trans('gtdxyz-flarum-badges.admin.badge.visible')}</b>,
            <div className="helpText">{app.translator.trans('gtdxyz-flarum-badges.admin.badge.visible_description')}</div>,
          ]
        )}
      </div>,
      50
