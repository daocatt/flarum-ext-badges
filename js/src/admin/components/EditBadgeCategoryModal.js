...
export default class EditBadgeCategoryModal extends Modal {
  ...
  data() {
    ...
    items.add(
      'description',
      <div className="Form-group">
        <label>{app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.description')}:</label>
        <textarea
          className="FormControl"
    ...
    items.add(
      ...
      <div className="Form-group">
        {Switch.component(
          ...
          [
            <b>{app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.blockview')}</b>,
            <div className="helpText">{app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.blockview_description')}</div>,
          ]
        )}
      </div>,
      50
    ...
    items.add(
      ...
      <div className="Form-group">
        {Switch.component(
          ...
          [
            <b>{app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.enabled')}</b>,
            <div className="helpText">{app.translator.trans('gtdxyz-flarum-badges.admin.badge_category.enabled_description')}</div>,
          ]
        )}
      </div>,
      50
