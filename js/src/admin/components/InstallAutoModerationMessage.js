    ...
    return (
      <div className={'FlarumBadges-install-dependency'}>
        <div className={'FlarumBadges-install-dependency-title'}>
          {app.translator.trans('gtdxyz-flarum-badges.admin.auto_moderator.not_installed.title')}
        </div>
          ...
          >
            ...
            <span class="Button-label">
              {app.translator.trans(
                extensionInstalled ? 'core.admin.extension.open_modal' : 'gtdxyz-flarum-badges.admin.auto_moderator.not_installed.install'
              )}
            </span>
          </a>
          <Button
